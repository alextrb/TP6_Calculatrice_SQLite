...
public class CalculatorActivity extends AppCompatActivity implements DisplayFragment.OnFragmentDisplayListener, KeyboardFragment.OnFragmentInteractionListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_etf) {
            Intent intent = new Intent(this, EditTextFragmentActivity.class);
            startActivity(intent); // on démarre l'activité avec les deux EditTexts
            return true;
        }
